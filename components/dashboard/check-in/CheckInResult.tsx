...
const CheckInResult = ({ result, onDismiss }: Props) => {
    ...
    return (
        <div className={`relative p-6 rounded-xl border-2 ${colors.bg} ${colors.border} animate-fade-in`}>
            <button
                onClick={onDismiss}
                className="absolute top-4 right-4 w-8 h-8 rounded-lg bg-primary-200 hover:bg-primary-100 flex items-center justify-center transition-colors"
                aria-label="Dismiss"
            >
            ...
            <div className="flex items-start gap-4 pr-10">
                ...
                <div className="flex-1">
                    ...
                    <p className={`normal-text-2 mb-4 ${colors.text}`}>
                        {result.message}
                    </p>
